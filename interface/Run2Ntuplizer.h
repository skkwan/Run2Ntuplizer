#ifndef Run2Ntuplizer_H
#define Run2Ntuplizer_H
...
#include "L1Trigger/Run2Ntuplizer/plugins/helpers.h"
...
class Run2Ntuplizer : public edm::EDAnalyzer {

 public:
  
  // Constructor
  Run2Ntuplizer(const edm::ParameterSet& ps);
  
  // Destructor
  virtual ~Run2Ntuplizer();
