...
#include "L1Trigger/Run2Ntuplizer/interface/Run2Ntuplizer.h"
...
Run2Ntuplizer::Run2Ntuplizer( const ParameterSet & cfg ) :
...
void Run2Ntuplizer::createBranchesTau(TTree *tree){
...
void Run2Ntuplizer::beginJob( const EventSetup & es) {
  cout<<"begin job..."<<std::endl;
}


void Run2Ntuplizer::analyze( const Event& evt, const EventSetup& es )
{
...
void Run2Ntuplizer::zeroOutAllVariables(){
...
void Run2Ntuplizer::endJob() {
}

Run2Ntuplizer::~Run2Ntuplizer(){

}

DEFINE_FWK_MODULE(Run2Ntuplizer);
